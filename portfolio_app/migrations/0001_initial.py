# Generated by Django 2.1.5 on 2019-02-01 06:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('web development', 'web development'), ('web design', 'web design'), ('photography', 'photography')], default='wen_development', max_length=255)),
                ('publish', models.DateTimeField(default=django.utils.timezone.now)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
            ],
