...
urlpatterns = [
    ...
    path('background/<int:pk>', BackgroundImagesDetailView.as_view(), name='background'),
    path('portfolio/<int:pk>', Portfolio_GalleryDetailView.as_view(), name='portfolio'),
    ...
    path('information/<int:pk>', BasicInformationDetailView.as_view(), name='information'),
